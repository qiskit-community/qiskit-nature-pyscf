...
version = qiskit_nature_pyscf.__version__
# The full version, including alpha/beta/rc tags
release = qiskit_nature_pyscf.__version__
...
vers = version.split(".")
link_str = f" https://github.com/qiskit-community/qiskit_nature_pyscf/blob/stable/{vers[0]}.{vers[1]}/docs/"
...
modindex_common_prefix = ["qiskit_nature_pyscf."]
